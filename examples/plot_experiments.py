...
if __name__ == '__main__':
    ...
    fp.superimpose_survey('POLARBEAR', color='blue', cbar=False)
    ...
    fp.superimpose_survey('BICEP2-CONVEX', color='blue', cbar=False)
    ...
    fp.superimpose_survey('SPIDER-90', color='blue', cbar=False)
    ...
    fp.superimpose_survey_outline('SPT-SZ', color='blue', cbar=False)
